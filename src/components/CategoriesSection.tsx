    ...
    <section className="py-14 md:py-20 bg-card">
      <div className="container mx-auto px-5 lg:px-12">
              ...
              <motion.div key={cat.id} variants={itemVariants}>
                ...
                >
                  <div className="relative h-40 sm:h-48 md:h-56 overflow-hidden">
                    ...
                    <h3 className="absolute bottom-4 left-4 right-4 text-primary-foreground text-lg sm:text-xl md:text-2xl font-bold">
                      {cat.title}
                    </h3>
        ...
        <div className="text-center mt-10 md:mt-12">
          <Link
            to="/menu"
            className="inline-flex items-center gap-3 bg-foreground text-background px-8 py-4 rounded-full font-bold shadow-xl hover:shadow-2xl transition-all"
          >
            View All Categories
