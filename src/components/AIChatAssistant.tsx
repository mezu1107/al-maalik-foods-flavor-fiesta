...
const AIChatAssistant = () => {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "Assalam o Alaikum! 👋 I'm your AI ordering assistant at Al Maalik Foods. Tell me what you'd like to eat — in English or Urdu!\n\nTry: \"mujhe 2 seekh kabab aur 1 biryani chahiye\"" },
  ]);
  ...
  const handleWhatsAppOrder = () => {
    ...
    const whatsappMsg = encodeURIComponent(`🤖 AI Order - Al Maalik Foods\n\n${orderText}`);
