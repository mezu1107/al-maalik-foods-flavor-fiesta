      ...
      <nav className="backdrop-blur-xl bg-card/80 border-b border-border/50">
        <div className="container mx-auto px-4 sm:px-5 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-20">
            <Link to="/" className="flex items-center gap-1 font-heading font-extrabold text-xl md:text-2xl text-primary shrink-0">
              AL Maalik <span className="text-secondary">Foods</span>
            </Link>
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="w-72">
                  <SheetTitle className="font-heading text-primary text-xl mb-6">AL Maalik Foods</SheetTitle>
