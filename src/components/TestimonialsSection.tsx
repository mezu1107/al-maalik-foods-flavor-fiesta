...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Best biryani in town! The flavors are absolutely authentic and the delivery is always on time. AL Maalik Foods has become our family's go-to for every occasion.",
  },
  {
    id: 2,
    name: "Fatima Ali",
    ...
    rating: 5,
    text: "I've reviewed hundreds of restaurants and AL Maalik stands out for their consistency. Every dish is prepared with fresh ingredients and you can taste the quality.",
  },
  {
    id: 3,
    name: "Usman Raza",
    ...
    rating: 4,
    text: "We order from AL Maalik for all our office events. The catering service is professional, food is delicious, and the prices are very reasonable for the quality.",
  },
  {
    id: 4,
    name: "Sara Malik",
